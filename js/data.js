  ...
  meta: {
    ...
    prices: {
      ...
      },
      {
            ...
            "lowestPriceNote": "当前已收录的拓竹 PETG 囤货套装最低记录；6kg 无盘套装，折合 29.52 元/kg，不与单卷价格直接比较",
      ...
      },
      {
            ...
            "lowestPriceNote": "同款历史记录中的较低到手价；当前记录为 27.99 元，规格为 1.1kg 无料盘",
      ...
      lowestByGroup: {
        "拓竹|PLA": { price: "56.88", date: "2026-07-31", basis: "近90天可查最低", updatedAt: "2026-09-05", note: "近90天仅收录到1条官方店铺公开记录；2026-02-07的50.98元超出窗口" },
        "拓竹|PETG": { price: "36.67", date: "2026-08-09", basis: "近90天可查最低", updatedAt: "2026-09-05", note: "按单卷到手价比较；6kg套装另有29.52元/kg的套装低价" },
        "拓竹|TPU 95A": { price: "100.05", date: "2025-11-08", basis: "已有公开史低", updatedAt: "2026-09-05", note: "无近90天公开促销记录；100.05元为无料盘款，当前记录为含料盘款" },
        "Jayo|PETG": { price: "26.59", date: "2026-06", basis: "近90天可查最低", updatedAt: "2026-09-05", note: "同款历史记录；当前公开记录为27.99元，规格均为1.1kg无料盘" },
        ...
        "彩多屋|PETG-CF": { price: "15.9", date: "2026-06-04", basis: "已有记录最低", updatedAt: "2026-09-05", note: "200g体验装；记录日期早于近90天窗口3天，按79.5元/kg折算" },
      ...
      summary: "价格数据更新时间：2026-09-05。当前展示30条记录：其中11条为创想三维官方商城商品页于2026-09-05重新核对的挂牌价，19条为京东/天猫官方店铺的历史促销快照，链接经第三方聚合页留存，不能视为当前实时价。史低只展示有历史记录支撑的价格；其余只显示当前已收录价或未核实，不把普通促销价冒充绝对史低。所有价格都必须以打开来源页后的实时规格、克重、优惠和运费为准。已清洗剔除：1688批量价、天猫精选/工厂渠道、店铺名未核实、克重存疑、天天特卖等非品牌店铺来源。每条记录均有recordedAt；价格排行统一将字段转为数值；商品标题明确克重但原记录未填pricePerKg的条目按克重折算并在界面以*标记，未明确规格仍保持未披露。"
    },
  },
