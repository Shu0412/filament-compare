  ...
  meta: {
    ...
    corrections: [
      ...
      },
      {
        date: "2026-09-05",
        item: "史低价格展示补全",
        issue: "价格表保留了史低列，但清洗后全部为null，用户无法看到已有的历史低价记录。",
        fix: "恢复4条有记录支撑的史低/已收录低价，并新增5条可追溯史低记录表；同时标注日期、规格和证据级别。没有可靠依据的条目继续显示“未披露”，不把普通促销价冒充绝对史低。"
      },
      {
        date: "2026-09-05",
      ...
      {
        date: "2026-09-05",
        item: "每kg低价与史低单位统一 + 原价补全",
        issue: "价格明细中的史低列混用了单卷价、套装总价和每kg价，导致拓竹 PETG 六卷套装的 29.52 元/kg 明显低于史低列 36.67 元；另有多条记录缺少原价。",
        fix: "低价列统一按元/kg比较和展示；当当前记录每kg价低于已收录低价时，以当前每kg价覆盖并保留记录日期。补齐6条缺失原价，并为同款挂牌参考、套装折算、券前/划线价反推和当前记录价Fallback分别标注依据。"
      }
    ],
    prices: {
      updatedAt: "2026-09-05",
      items: [
      {
            ...
            "listPrice": "69.0",
            "listPriceBasis": "同款无料盘当前挂牌价参考；含料盘SKU独立划线价未留存",
            "dealPrice": "56.88",
            "pricePerKg": "56.88",
            "lowestPrice": null,
      ...
      },
      {
            ...
            "listPrice": "306.0",
            "listPriceBasis": "同款单卷挂牌价51元×6折算；套装独立划线价未留存",
            "dealPrice": "177.11",
            "pricePerKg": "29.52",
            "lowestPrice": "29.52",
            "lowestPriceDate": "2026-07-20",
            "lowestPriceNote": "按6kg套装到手总价177.11元折算；29.52元/kg低于单卷记录36.67元/kg",
      ...
      },
      {
            ...
            "pricePerKg": "109.5",
            "lowestPrice": "100.05",
            "lowestPriceDate": "2025-11-08",
            "lowestPriceNote": "同品牌同材料历史促销低价；天猫官方旗舰店无料盘款，规格与当前含料盘款不同",
      ...
      },
      {
            ...
            "pricePerKg": "25.45",
            "lowestPrice": "25.45",
            "lowestPriceDate": "2026-06",
            "lowestPriceNote": "当前记录27.99元/1.1kg=25.45元/kg，按用户规则覆盖已收录低价数值26.59",
      ...
      },
      {
            ...
            "listPrice": "45.9",
            "listPriceBasis": "领券前/当前划线价由到手34.9元+11元券额反推",
            "dealPrice": "34.9",
            "pricePerKg": "34.9",
            "lowestPrice": null,
            ...
            "pricePerKg": "20.0",
            "lowestPrice": "20.0",
            "lowestPriceDate": "2026-08-09",
            "lowestPriceNote": "爱乐酷 PLA 1kg 款已收录最低价级别；来源为官方旗舰店聚合快照，仍需以商品页实时规格为准",
      ...
      },
      {
            ...
            "listPrice": "15.9",
            "listPriceBasis": "当前可见记录价；独立划线价未留存",
            "dealPrice": "15.9",
            "pricePerKg": "79.5",
            "lowestPrice": null,
            "discount": "现售价15.9元",
            ...
            "listPrice": "28.9",
            "listPriceBasis": "当前可见记录价；来源页未留存独立划线价",
            "dealPrice": "28.9",
            "pricePerKg": "28.9",
            "lowestPrice": null,
            "discount": null,
      ...
      lowestByGroup: {
        "拓竹|PLA": { price: "50.98", date: "2026-02-07", basis: "当前每kg低价覆盖", updatedAt: "2026-09-05", note: "50.98元/kg低于近90天记录56.88元/kg；该记录超出近90天窗口，按用户规则保留并明确日期" },
        "拓竹|PETG": { price: "29.52", date: "2026-07-20", basis: "当前每kg低价覆盖", updatedAt: "2026-09-05", note: "6kg套装到手177.11元折合29.52元/kg，低于单卷记录36.67元/kg" },
        "拓竹|TPU 95A": { price: "100.05", date: "2025-11-08", basis: "已有公开史低", updatedAt: "2026-09-05", note: "无近90天公开促销记录；100.05元为无料盘款，当前记录为含料盘款" },
        "Jayo|PETG": { price: "25.45", date: "2026-07-22", basis: "当前每kg低价覆盖", updatedAt: "2026-09-05", note: "当前记录27.99元/1.1kg=25.45元/kg，低于已收录同款历史低价数值26.59；历史记录仍保留在追溯表" },
        "Polymaker|PLA": { price: "43.64", date: "2026-08-09", basis: "近90天可查最低", updatedAt: "2026-09-05", note: "PolyTerra 1kg无盘款；PolyMax记录因克重未披露不参与比较" },
        "Polymaker|PETG": { price: "42", date: "2026-08-09", basis: "近90天可查最低", updatedAt: "2026-09-05", note: "高速PETG HF 1kg款；同品牌PolyLite PETG同期记录为57.65元" },
        "三绿|PLA": { price: "34.9", date: "2026-01-13", basis: "已有记录最低", updatedAt: "2026-09-05", note: "当前库没有2026-06-07之后的公开促销记录，克重仍未完全确认" },
        "爱乐酷|PLA": { price: "20", date: "2026-08-09", basis: "已有公开史低级别", updatedAt: "2026-09-05", note: "1kg款；来源为官方旗舰店聚合快照，活动条件仍需打开来源页复核" },
        "爱乐酷|ABS": { price: "49.54", date: "2026-08-09", basis: "近90天可查最低", updatedAt: "2026-09-05", note: "1kg款官方旗舰店活动记录" },
        "爱乐酷|ASA": { price: "55.18", date: "2026-08-09", basis: "近90天可查最低", updatedAt: "2026-09-05", note: "1kg款官方旗舰店活动记录" },
        "彩多屋|PETG-CF": { price: "79.5", date: "2026-06-04", basis: "已有记录最低", updatedAt: "2026-09-05", note: "200g体验装15.9元，统一按79.5元/kg展示；记录日期早于近90天窗口3天" },
        "启庞|PLA": { price: "28.9", date: "2026-05-04", basis: "已有记录最低", updatedAt: "2026-09-05", note: "1kg丝绸PLA；当前库没有近90天公开促销记录" },
        "启庞|PA": { price: "80.1", date: "2026-05-04", basis: "已有记录最低", updatedAt: "2026-09-05", note: "1kg PA6尼龙；当前库没有近90天公开促销记录" },
        "创想三维|PLA": { price: "132", date: "2026-09-05", basis: "当前官方页复核价", updatedAt: "2026-09-05", note: "未找到近90天可核验的同款公开促销记录；官方商城挂牌价" },
        "创想三维|PLA+": { price: "160", date: "2026-09-05", basis: "当前官方页复核价", updatedAt: "2026-09-05", note: "未找到近90天可核验的同款公开促销记录；官方商城挂牌价" },
        "创想三维|PETG": { price: "109", date: "2026-09-05", basis: "当前官方页复核价", updatedAt: "2026-09-05", note: "Hyper PETG官方挂牌价；CR-PETG同材料记录为118元" },
        "创想三维|ABS": { price: "108", date: "2026-09-05", basis: "当前官方页复核价", updatedAt: "2026-09-05", note: "CR-ABS官方挂牌价；Hyper ABS同材料记录为149元" },
        "创想三维|ASA": { price: "200", date: "2026-09-05", basis: "当前官方页复核价", updatedAt: "2026-09-05", note: "未找到近90天可核验的同款公开促销记录；官方商城挂牌价" },
        "创想三维|TPU 95A": { price: "168", date: "2026-09-05", basis: "当前官方页复核价", updatedAt: "2026-09-05", note: "未找到近90天可核验的同款公开促销记录；官方商城挂牌价" },
        "创想三维|PLA-CF": { price: "233.6", date: "2026-09-05", basis: "当前官方页复核价", updatedAt: "2026-09-05", note: "未找到近90天可核验的同款公开促销记录；官方商城挂牌价" },
        "创想三维|PETG-CF": { price: "239", date: "2026-09-05", basis: "当前官方页复核价", updatedAt: "2026-09-05", note: "未找到近90天可核验的同款公开促销记录；官方商城挂牌价" },
        "创想三维|PA-CF": { price: "409", date: "2026-09-05", basis: "当前官方页复核价", updatedAt: "2026-09-05", note: "未找到近90天可核验的同款公开促销记录；官方商城挂牌价" }
      },
      history: [
        { brand: "拓竹", material: "PLA", price: "49.05", unit: "1kg/卷", date: "2025", source: "什么值得买京东优惠记录", confidence: "低", note: "具体店铺未核实，仅作为历史参考，不并入当前官方店铺记录" },
        { brand: "拓竹", material: "TPU 95A", price: "100.05", unit: "1kg/卷", date: "2025-11-08", source: "天猫官方旗舰店历史促销快照", confidence: "中", note: "无料盘款；当前表格记录为含料盘款，规格不同" },
        { brand: "拓竹", material: "PA-CF", price: "336.6", unit: "1kg/卷", date: "历史记录", source: "慢慢买历史价格快照", confidence: "中", note: "平台未注明，活动已结束；仅作同品牌同材料历史参考" },
        { brand: "Jayo", material: "PETG", price: "26.59", unit: "1.1kg/卷", date: "2026-06", source: "同款历史促销记录", confidence: "中", note: "当前已核实记录为27.99元，当前表格每kg价为25.45元" },
        { brand: "爱乐酷", material: "PLA", price: "20", unit: "1kg/卷", date: "2026-08-09", source: "天猫官方旗舰店聚合快照", confidence: "中", note: "记录明确写为史低价级别，但仍需打开来源页复核活动条件" }
      ],
      summary: "价格数据更新时间：2026-09-05。当前展示30条记录：其中11条为创想三维官方商城商品页于2026-09-05重新核对的挂牌价，19条为京东/天猫官方店铺的历史促销快照，链接经第三方聚合页留存，不能视为当前实时价。原价优先使用记录中的挂牌/划线价；页面未留存独立原价时，使用同款挂牌折算、券前价反推或当前可见记录价，并在鼠标提示中说明依据。史低/近90天低价统一按元/kg展示；若当前记录的每kg价更低，则覆盖原低价数值并保留记录日期。所有价格都必须以打开来源页后的实时规格、克重、优惠和运费为准。已清洗剔除：1688批量价、天猫精选/工厂渠道、店铺名未核实、克重存疑、天天特卖等非品牌店铺来源。每条记录均有recordedAt；商品标题明确克重但原记录未填pricePerKg的条目按克重折算并在界面以*标记，未明确规格仍保持未披露。"
    },
  },
